...
dict(ticker="LULU",company="Lululemon Athletica",exch="NASDAQ",spot=127.0,cap=15.2,sh=114.0,cash=1.8,rev_b=11.1,
 ...
 chartref=[("history_years",[2021,2022,2023,2024,2025]),("history_revenue",[6.25,8.11,9.62,10.59,11.1]),("history_fcf",[0.7,0.9,1.3,1.64,1.58]),("history_ev_rev",[6.0,5.0,3.5,2.5,1.2])],
